    ...
    var body: some View {
        VStack {
            ...
            HStack(alignment: .center, spacing: 8) {
                ...
                Text("Left Over Pins")
                    .foregroundColor(viewModel.selectingFallenPins ? .gray : .black)
                    .font(.system(size: viewModel.selectingFallenPins ? 12 : 16, weight: viewModel.selectingFallenPins ? .regular : .bold))
                    .multilineTextAlignment(.leading)
                Text("Fallen Pins")
                    .foregroundColor(viewModel.selectingFallenPins ? .black : .gray)
                    .font(.system(size: viewModel.selectingFallenPins ? 16 : 12, weight: viewModel.selectingFallenPins ? .bold : .regular))
